...
void InitVariable()
{
					...
					Navigation.Bidding_State=Bidding_Init;
...
uchar temp[12];
	...
	__enable_interrupt();
	    ...
	    while(1)
        {
			...
			if(Key.B_Any!=Key_Start) //Any Key pressed
					{
						switch (Taxi_Mode)
								{
									case Vacant_State:
									switch (Key.B_Any)
										...
										*/
												...
												case	Key_Accept:
														if(Navigation.Bidding_State==Bidding_msg_Received)
														{
														Navigation.Bidding_State=Bidding_Accepted;	
										...
										switch (Key.B_Any)
									{
										...
										*/
										...
										tone(1);
										Taxi_Mode=Vacant_State;
									//	if(Navigation.Bidding_State==Bidding_Accepted)
									//	{
										Navigation.Bidding_State=Bidding_Init;	
									//	}										
										Navigation.GMODE=Vaccant_Mode;
